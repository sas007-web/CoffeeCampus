...
{
    /// <inheritdoc />
    public partial class kaffe : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HoseChanges", x => x.HoseChangeID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Services_CoffeeMachines_CoffeeMachineID",
                        column: x => x.CoffeeMachineID,
                        principalTable: "CoffeeMachines",
                        principalColumn: "CoffeeMachineID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CoffeeMachineID = table.Column<int>(type: "int", nullable: false),
                    CleaningDateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ResponsiblePersonId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ReminderSentDateTime = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MachineCleanings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MachineCleanings_CoffeeMachines_CoffeeMachineID",
                        column: x => x.CoffeeMachineID,
                        principalTable: "CoffeeMachines",
                        principalColumn: "CoffeeMachineID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MachineCleanings_CoffeeMachineID",
                table: "MachineCleanings",
                column: "CoffeeMachineID");

            migrationBuilder.CreateIndex(
                name: "IX_MachineCleanings_ResponsiblePersonId",
                table: "MachineCleanings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Services_CoffeeMachineID",
                table: "Services",
                column: "CoffeeMachineID");
        }
